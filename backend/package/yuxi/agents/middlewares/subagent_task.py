...
TASK_TOOL_DESCRIPTION = """Launch a configured subagent in 联合智擎 to handle an isolated task.
...
SUBAGENT_START_DESCRIPTION = """Start a configured subagent in 联合智擎 asynchronously.
